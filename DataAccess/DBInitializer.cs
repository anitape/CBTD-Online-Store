...
namespace DataAccess
{
    public class DbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
            new Manufacturer { ManufacturerName = "Coca Cola" },
            new Manufacturer { ManufacturerName = "Yellow Tail"},
            new Manufacturer { ManufacturerName = "Trinchero Family Estates" },
            new Manufacturer { ManufacturerName = "Frito Lay" }
            };
