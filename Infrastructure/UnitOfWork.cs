...
namespace DataAccess
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        IGenericRepository<Category> IUnitOfWork.Category => throw new NotImplementedException();

        IGenericRepository<Manufacturer> IUnitOfWork.Manufacturer => throw new NotImplementedException();

        IGenericRepository<Product> IUnitOfWork.Product => throw new NotImplementedException();

		IGenericRepository<ApplicationUser> IUnitOfWork.ApplicationUser => throw new NotImplementedException();

        IGenericRepository<ShoppingCart> IUnitOfWork.ShoppingCart => throw new NotImplementedException();

        IOrderHeaderRepository<OrderHeader> IUnitOfWork.OrderHeader => throw new NotImplementedException();

        IGenericRepository<OrderDetails> IUnitOfWork.OrderDetails => throw new NotImplementedException();
